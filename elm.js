...
Elm.Challenge5 = Elm.Challenge5 || {};
Elm.Challenge5.make = function (_elm) {
   "use strict";
   _elm.Challenge5 = _elm.Challenge5 || {};
   if (_elm.Challenge5.values)
   return _elm.Challenge5.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Challenge5",
   $Basics = Elm.Basics.make(_elm),
   ...
   var inputToHighScore = function (input) {
      return function () {
         switch (input.ctor)
         {case "HighScoreEntered":
            return $Maybe.Just(input._0);}
   ...
   var HighScoreEntered = function (a) {
      return {ctor: "HighScoreEntered"
             ,_0: a};
   };
   var PopFruit = function (a) {
      return {ctor: "PopFruit"
             ,_0: a};
   };
   var Space = function (a) {
      return {ctor: "Space",_0: a};
   };
   var actions = $Signal.mailbox(Space(false));
   var DeltaKeys = F2(function (a,
   b) {
      return {ctor: "DeltaKeys"
             ,_0: a
             ,_1: b};
   });
   var Body = {ctor: "Body"};
                 ...
                 switch (l._1._1.ctor)
                   {case "[]":
                      return $Maybe.Just({ctor: "_Tuple2"
                                         ,_0: $String.trim(l._0)
                                         ,_1: $String.trim(l._1._0)});}
                   break;}
              break;}
         return $Maybe.Nothing;
      }();
   };
   var toStyle = function (s) {
      return function () {
         var attrs = $String.split(";")($String.trim(s));
         var attrs$ = A2($List.map,
         function (s$) {
            return $String.split(":")($String.trim(s$));
         },
         attrs);
         return $Html$Attributes.style(A2($List.filterMap,
         toPair,
         attrs$));
      }();
   };
   var moveHead = F2(function (dir,
   _v9) {
      return function () {
         switch (_v9.ctor)
         {case "_Tuple2":
   ...
   var newPos = F2(function (dir,
   snake) {
      return function () {
         var body = A2($List.take,
         $List.length(snake) - 1,
         snake);
         var head$ = $List.head(body);
         var head = function () {
            switch (head$.ctor)
            {case "Just":
               switch (head$._0.ctor)
   ...
   var scoreFromSpeed = function (s) {
      return $Basics.truncate((s - 3) / 2 * 100);
   };
   var newHighScore = F2(function (speed,
   highScores) {
      return function () {
         var scores = $Basics.snd($List.unzip(highScores));
         var min = function () {
            var _v18 = $List.minimum(scores);
            switch (_v18.ctor)
         ...
         return _U.cmp(scoreFromSpeed(speed),
         min) > 0;
      }();
   });
   var updateHighScores = F3(function (name,
   speed,
   highScores) {
      return function () {
         var highScore = scoreFromSpeed(speed);
         var highScores$ = A2($List._op["::"],
         {ctor: "_Tuple2"
         ,_0: name
         ,_1: highScore},
         highScores);
         var newHighScores = $List.reverse(A2($List.sortBy,
         function (_v20) {
            return function () {
               switch (_v20.ctor)
               {case "_Tuple2":
   ...
   var highScoreInput = F2(function (address,
   snake) {
      return A2($Html.div,
      _L.fromArray([toStyle("display:flex; position:absolute; top:0; left:0;justify-content:center;align-items:center;width:100%;height:100%;")]),
      _L.fromArray([A2($Html.input,
      _L.fromArray([toStyle("font-size:40px;")
                   ,$Html$Attributes.type$("input")
                   ,$Html$Attributes.value(snake.name)
                   ,$Html$Attributes.placeholder("Enter your name")
                   ,A3($Html$Events.on,
                   "input",
                   $Html$Events.targetValue,
                   function ($) {
                      return $Signal.message(address)(UpdateName($));
                   })
                   ,A2(onEnter,
                   address,
                   HighScoreEntered(A3(updateHighScores,
                   snake.name,
                   snake.speed,
                   snake.highScores)))]),
      _L.fromArray([]))]));
   });
   var updateDelta = F2(function (t,
   snake) {
      return function () {
         var newDelta = snake.delta + t;
         return _U.cmp(newDelta,
         20 / snake.speed) > 0 ? _U.replace([["delta"
                                             ,0]],
         snake) : _U.replace([["delta"
                              ,newDelta]],
         snake);
      }();
   });
   var initHS = A2($Maybe.withDefault,
   A2($List.repeat,
   5,
   ...
   var HighScore = {ctor: "HighScore"};
   var End = {ctor: "End"};
   var Paused = {ctor: "Paused"};
   var Active = {ctor: "Active"};
   var toggleGame = function (status) {
      return function () {
         switch (status.ctor)
   ...
   var moveIfActive = function (snake) {
      return function () {
         var body = snake.body;
         var $ = A2(newPos,
         snake.dir,
         ...
         return _U.eq(snake.status,
         Active) && _U.eq(delta,
         0) ? _U.eq(snake.fruit,
         $Maybe.Just(newHead)) ? _U.replace([["body"
                                             ,A2($List._op["::"],
                                             newHead,
                                             snake.body)]
                                            ,["fruit",$Maybe.Nothing]
                                            ,["speed",snake.speed + 0.5]],
         snake) : _U.replace([["body"
                              ,A2($List._op["::"],
                              newHead,
                              newBody)]],
         snake) : snake;
   ...
   var Left = {ctor: "Left"};
   var updateDirection = F2(function (keys,
   snake) {
      return function () {
         var newDir = _U.cmp(keys.x,
         0) < 0 && (_U.eq(snake.dir,
         Up) || _U.eq(snake.dir,
         Down)) ? Left : _U.cmp(keys.x,
         0) > 0 && (_U.eq(snake.dir,
         Up) || _U.eq(snake.dir,
         Down)) ? Right : _U.cmp(keys.y,
         0) > 0 && (_U.eq(snake.dir,
         Left) || _U.eq(snake.dir,
         Right)) ? Up : _U.cmp(keys.y,
         0) < 0 && (_U.eq(snake.dir,
         Left) || _U.eq(snake.dir,
         Right)) ? Down : snake.dir;
         return _U.eq(snake.dir,
         newDir) ? snake : _U.replace([["dir"
                                       ,newDir]
                                      ,["delta",0]],
         snake);
      }();
   ...
   var pitBlock = 22;
   var fruitImg = $Graphics$Collage.toForm(A3($Graphics$Element.image,
   pitBlock,
   pitBlock,
   "https://raw.githubusercontent.com/pdamoc/elmChallenges/master/apple.png"));
   var pitHeight = 30;
   var pitWidth = 40;
   var startSnake = {_: {}
                    ,body: _L.fromArray([{ctor: "_Tuple2"
                                         ,_0: pitWidth / 2 | 0
                                         ,_1: pitHeight / 2 | 0}
                                        ,{ctor: "_Tuple2"
                                         ,_0: (pitWidth / 2 | 0) - 1
                    ...
                    ,speed: 3
                    ,status: Start};
   var outside = function (_v25) {
      return function () {
         switch (_v25.ctor)
         {case "_Tuple2":
            return $Basics.not(_U.cmp(_v25._0,
              0) > -1 && _U.cmp(_v25._0,
              pitWidth) < 0 && (_U.cmp(_v25._1,
              0) > -1 && _U.cmp(_v25._1,
              pitHeight) < 0));}
         _U.badCase($moduleName,
         "on line 201, column 18 to 77");
      }();
   };
   var endIfCollision = function (snake) {
      return function () {
         var body = snake.body;
         var $ = A2(newPos,
         snake.dir,
         ...
         return _U.eq(snake.status,
         Active) && (_U.eq(delta,
         0) && (outside(newHead) || A2($List.member,
         newHead,
         body))) ? _U.replace([["status"
                               ,A2(newHighScore,
                               snake.speed,
                               snake.highScores) ? HighScore : End]],
         snake) : snake;
      }();
   };
   ...
   snake) {
      return function () {
         switch (input.ctor)
         {case "DeltaKeys":
            return $Debug.watch("snake")(moveIfActive(endIfCollision(updateDirection(A2($Debug.watch,
              "keys",
              input._1))(A2(updateDelta,
              input._0,
              snake)))));
            case "HighScoreEntered":
            return _U.replace([["highScores"
                               ,input._0]
                              ,["name",""]
                              ,["status",End]],
              snake);
            ...
            switch (input._0.ctor)
              {case "_Tuple2":
                 return !_U.eq(snake.status,
                   Active) ? snake : !_U.eq(snake.fruit,
                   $Maybe.Nothing) ? snake : A2($List.member,
                   {ctor: "_Tuple2"
                   ,_0: input._0._0
                   ,_1: input._0._1},
                   snake.body) ? snake : _U.eq(input._0._0,
                   -1) ? snake : _U.replace([["fruit"
              ...
              break;
            case "Space":
            return input._0 && _U.eq(snake.status,
              End) ? _U.replace([["status"
                                 ,toggleGame(snake.status)]
                                ,["highScores"
                                 ,snake.highScores]],
              startSnake) : input._0 ? _U.replace([["status"
                                                   ,toggleGame(snake.status)]],
              snake) : snake;
            case "UpdateName":
            return _U.replace([["name"
              ...
              snake);}
         _U.badCase($moduleName,
         "between lines 165 and 197");
      }();
   });
   var highScoresLine = function (_v38) {
      return function () {
         switch (_v38.ctor)
         {case "_Tuple2":
            switch (_v38._1.ctor)
              {case "_Tuple2":
                 return function () {
                      var score$ = $Basics.toString(_v38._1._1);
                      var dotsNeeded = 30 - $String.length(_v38._1._0) - $String.length($Basics.toString(_v38._1._1));
                      var dots = A2($String.repeat,
                      dotsNeeded,
                      ".");
                      var pos = $Basics.toString(_v38._0 + 1);
                      var txt = $Text.fromString(A2($Basics._op["++"],
                      " ",
                      A2($Basics._op["++"],
                      pos,
                      A2($Basics._op["++"],
                      ...
                      _U.cmp(_v38._1._1,
                      0) > 0 ? score$ : "."))))));
                      return $Graphics$Element.width(pitWidth * pitBlock - 2 * pitBlock)($Graphics$Element.leftAligned($Text.height(40)($Text.color($Color.white)($Text.monospace(txt)))));
                   }();}
              break;}
         _U.badCase($moduleName,
         "between lines 240 and 249");
      }();
   };
   var highScoresList = function (highScores) {
      return function () {
         var header = $Graphics$Element.width(pitWidth * pitBlock - 2 * pitBlock)($Graphics$Element.centered($Text.height(40)($Text.color($Color.white)($Text.monospace($Text.fromString("High Scores"))))));
         var hsList = A2($List.indexedMap,
         F2(function (v0,v1) {
            return {ctor: "_Tuple2"
                   ,_0: v0
                   ,_1: v1};
         ...
         highScores);
         return $Graphics$Collage.toForm($Graphics$Element.flow($Graphics$Element.down)(A2($Basics._op["++"],
         _L.fromArray([header]),
         A2($List.map,
         highScoresLine,
         hsList))));
   ...
   var moveXY = function (_v44) {
      return function () {
         switch (_v44.ctor)
         {case "_Tuple2":
            return $Graphics$Collage.move({ctor: "_Tuple2"
                                          ,_0: $Basics.toFloat(((0 - pitWidth) / 2 | 0) + _v44._0) * pitBlock + pitBlock / 2
                                          ,_1: $Basics.toFloat((pitHeight / 2 | 0) - _v44._1) * pitBlock - pitBlock / 2});}
         _U.badCase($moduleName,
         "between lines 362 and 363");
      }();
   };
   var coloredText = F2(function (s,
   c) {
      return moveXY({ctor: "_Tuple2"
                    ,_0: pitWidth / 2 | 0
                    ,_1: 4 * (pitHeight / 5 | 0)})($Graphics$Collage.text($Text.height(40)($Text.color(c)($Text.monospace($Text.fromString(s))))));
   });
   var renderSnakePart = F2(function (part,
   _v48) {
      return function () {
         switch (_v48.ctor)
         {case "_Tuple2":
            return function () {
                 var partColor = function () {
                    switch (part.ctor)
                    {case "Body":
                       return $Color.yellow;
                       case "Head":
                 ...
                 return moveXY({ctor: "_Tuple2"
                               ,_0: _v48._0
                               ,_1: _v48._1})($Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled(partColor)(A2($Graphics$Collage.rect,
                                                                                   pitBlock,
                                                                                   pitBlock))
                                                                                   ,$Graphics$Collage.outlined($Graphics$Collage.solid($Color.darkBrown))(A2($Graphics$Collage.rect,
                                                                                   pitBlock,
                                                                                   pitBlock))
                                                                                   ,_U.eq(part,
                                                                                   Head) ? $Graphics$Collage.outlined($Graphics$Collage.solid($Color.red))(A2($Graphics$Collage.ngon,
                                                                                   5,
                                                                                   pitBlock / 2.2)) : $Graphics$Collage.outlined($Graphics$Collage.solid($Color.darkBrown))(A2($Graphics$Collage.rect,
                                                                                   pitBlock / 1.2,
                                                                                   pitBlock / 1.2))])));
              }();}
         _U.badCase($moduleName,
         "between lines 368 and 382");
      }();
   });
   ...
   snake) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var highScoreForm = function () {
                    var _v60 = snake.status;
                    switch (_v60.ctor)
                    {case "HighScore":
                       return _L.fromArray([A2(highScoreInput,
                         address,
                         snake)]);}
                    return _L.fromArray([]);
                 }();
                 var score = scoreFromSpeed(snake.speed);
                 var msg = function () {
                    var _v61 = snake.status;
                    switch (_v61.ctor)
                    {case "Active": return "";
                       case "End":
                    ...
                    _U.badCase($moduleName,
                    "between lines 311 and 318");
                 }();
                 var scoreText = _U.eq(snake.status,
                 Active) ? $Basics.toString(score) : "";
                 var scoreForm = moveXY({ctor: "_Tuple2"
                                        ,_0: pitWidth / 2 | 0
                                        ,_1: 0})($Graphics$Collage.text($Text.height(40)($Text.color($Color.darkGrey)($Text.monospace($Text.fromString(scoreText))))));
                 var fruit = function () {
                    var _v62 = snake.fruit;
                    switch (_v62.ctor)
                    {case "Just":
                       switch (_v62._0.ctor)
                         {case "_Tuple2":
                            return _L.fromArray([moveXY({ctor: "_Tuple2"
                                                        ,_0: _v62._0._0
                                                        ,_1: _v62._0._1})(fruitImg)]);}
                         break;
                       case "Nothing":
                       return _L.fromArray([]);}
                    _U.badCase($moduleName,
                 ...
                 var pitHeight$ = $Basics.toFloat(pitHeight) * pitBlock;
                 var pitWidth$ = $Basics.toFloat(pitWidth) * pitBlock;
                 var info = function () {
                    var _v66 = snake.status;
                    switch (_v66.ctor)
                    {case "Active":
                       return _L.fromArray([]);
                       case "End":
                       return _L.fromArray([$Graphics$Collage.filled(A4($Color.rgba,
                                           100,
                                           100,
                                           100,
                                           0.8))(A2($Graphics$Collage.rect,
                                           pitWidth$ - 2 * pitBlock,
                                           pitHeight$ - 2 * pitBlock))
                                           ,$Graphics$Collage.move({ctor: "_Tuple2"
                                                                   ,_0: 0.0
                                                                   ,_1: $Basics.toFloat(2) * pitBlock})(highScoresList(snake.highScores))
                                           ,A2(coloredText,
                                           msg,
                                           $Color.white)]);
                       case "HighScore":
                       return _L.fromArray([$Graphics$Collage.filled(A4($Color.rgba,
                                           ...
                                           msg,
                                           $Color.white)]);}
                    return _L.fromArray([A2(coloredText,
                    msg,
                    $Color.white)]);
                 }();
                 var $ = {ctor: "_Tuple2"
                         ,_0: $Basics.toFloat(_v56._0)
                         ,_1: $Basics.toFloat(_v56._1)},
                 w = $._0,
                 h = $._1;
                 return A2($Html.div,
                 _L.fromArray([]),
                 A2($Basics._op["++"],
                 _L.fromArray([$Html.fromElement(A2($Graphics$Collage.collage,
                 _v56._0,
                 _v56._1)(A2($Basics._op["++"],
                 _L.fromArray([$Graphics$Collage.filled(A3($Color.rgb,
                              29,
                              41,
                              81))(A2($Graphics$Collage.rect,
                              w,
                              h))
                              ,$Graphics$Collage.filled(_U.eq(snake.status,
                              End) ? $Color.red : $Color.darkBrown)(A2($Graphics$Collage.rect,
                              pitWidth$ + 2 * pitBlock,
                              pitHeight$ + 2 * pitBlock))
         ...
         _U.badCase($moduleName,
         "between lines 302 and 354");
      }();
   });
   var fruitGen = A2($Random.pair,
   $Random.$int(0)(pitWidth - 1),
   $Random.$int(0)(pitHeight - 1));
   var nextFruit = F2(function (t,
   _v67) {
      return function () {
         switch (_v67.ctor)
         {case "_Tuple2":
            switch (_v67._0.ctor)
              ...
              break;}
         _U.badCase($moduleName,
         "on line 412, column 3 to 32");
      }();
   });
   var fruitSig = $Signal.map(PopFruit)($Signal.map(function (a) {
      return $Basics.fst(a);
   })(A2($Signal.foldp,
   nextFruit,
   {ctor: "_Tuple2"
   ,_0: {ctor: "_Tuple2"
        ,_0: -1
        ,_1: 0}
   ,_1: $Random.initialSeed(42)})($Time.every(2 * $Time.second))));
   var input = function () {
      ...
      $Time.fps(30));
      return $Signal.mergeMany(_L.fromArray([$Signal.sampleOn(delta)(A3($Signal.map2,
                                            DeltaKeys,
                                            delta,
                                            $Keyboard.arrows))
                                            ,A2($Signal.map,
   ...
   $Window.dimensions,
   model);
   var highScoreSig = A3($Signal.filterMap,
   inputToHighScore,
   initHS,
   input);
   ...
   highScoreSig);
   _elm.Challenge5.values = {_op: _op
                            ,pitWidth: pitWidth
                            ,pitHeight: pitHeight
                            ,pitBlock: pitBlock
                            ,Left: Left
                            ...
                            ,scoreFromSpeed: scoreFromSpeed
                            ,newHighScore: newHighScore
                            ,endIfCollision: endIfCollision
                            ,moveIfActive: moveIfActive
                            ...
                            ,Body: Body
                            ,moveXY: moveXY
                            ,renderSnakePart: renderSnakePart
                            ...
                            ,Space: Space
                            ,PopFruit: PopFruit
                            ,HighScoreEntered: HighScoreEntered
                            ...
                            ,actions: actions
                            ,input: input
                            ,inputToHighScore: inputToHighScore
                            ,highScoreSig: highScoreSig};
   return _elm.Challenge5.values;
};
Elm.Char = Elm.Char || {};
